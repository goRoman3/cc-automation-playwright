...
export const CATALOG: CatalogEntry[] = [
  ...
  { id: 'agent-mgmt/get-agent', group: 'Agent Management', operation: 'Get Agent', match: /^Get Agent \(/,
  ...
  { id: 'agent-mgmt/get-supervisors', group: 'Agent Management', operation: 'Get Supervisors', match: /^Get Supervisors/,
    cls: 'read', reason: 'no params; site-scoping unconfirmed', source: 'ADO 37344; agent-management-api.spec.ts' },
  { id: 'agent-mgmt/get-agent-extensions', group: 'Agent Management', operation: 'Get Agent Extensions', match: /^Get Agent Extensions/,
  ...
  { id: 'calls/get-call-info', group: 'Calls', operation: 'Get Call Info', match: /^Get Call Info/,
    cls: 'read', idSource: 'callId from List Calls', reason: 'pointed by-id probe', source: 'calls-api.spec.ts' },
  { id: 'calls/get-call-notes', group: 'Calls', operation: 'Get Call Notes', match: /^Get Call Notes/,
    cls: 'read', idSource: 'callId from List Calls', reason: 'pointed by-id probe', source: 'calls-api.spec.ts' },
  ...
  { id: 'calls/edit-call-note-details', group: 'Calls', operation: 'Edit Call Note Details', match: /^Edit Call Note Details/,
  ...
  { id: 'calls/get-linked-calls', group: 'Calls', operation: 'Get Linked Calls', match: /^Get Linked Calls/,
    cls: 'read', idSource: 'callId from List Calls', reason: 'pointed by-id probe', source: 'calls-api.spec.ts' },
  { id: 'calls/get-call-transcription', group: 'Calls', operation: 'Get Call Transcription', match: /^Get Call Transcription/,
    cls: 'read', idSource: 'callId from List Calls', reason: 'pointed by-id probe', source: 'calls-api.spec.ts' },
  ...
  { id: 'calls/get-call-pci-data', group: 'Calls', operation: 'Get Call PCI Data', match: /^Get Call PCI Data/,
  ...
  { id: 'ext-mgmt/get-extension', group: 'Extension Management', operation: 'Get Extension', match: /^Get Extension/,
  ...
  { id: 'general/get-company-info', group: 'General Settings', operation: 'Get Company Info', match: /^Get Company Info/,
  ...
  { id: 'general/get-sso-configuration', group: 'General Settings', operation: 'Get SSO Configuration', match: /^Get SSO Configuration/,
    cls: 'read', reason: 'customer-level — confirmed unchanged', source: 'general-settings-api.spec.ts; tenant-isolation-staging' },
  { id: 'general/get-storage-locations', group: 'General Settings', operation: 'Get Storage Locations', match: /^Get Storage Locations/,
    cls: 'read', reason: 'customer-level — confirmed unchanged', source: 'general-settings-api.spec.ts; tenant-isolation-staging' },
  ...
  { id: 'group-mgmt/get-agent-group', group: 'Group Management', operation: 'Get Agent Group', match: /^Get Agent Group \(/,
  ...
  { id: 'ip-whitelist/list', group: 'IP Whitelist', operation: 'IP Whitelist List', match: /^IP Whitelist List/,
  ...
  { id: 'notifications/list-notifications-trigger-types', group: 'Notifications', operation: 'List Notifications Trigger Types', match: /^List Notifications Trigger Types/,
    cls: 'read', reason: 'global reference list', source: 'notifications-api.spec.ts' },
  { id: 'notifications/get-alert-trigger-topics', group: 'Notifications', operation: 'Get Alert Trigger Topics', match: /^Get Alert Trigger Topics/,
    cls: 'read', reason: 'global reference list', source: 'notifications-api.spec.ts' },
  ...
  { id: 'notifications/get-alert-configuration', group: 'Notifications', operation: 'Get Alert Configuration', match: /^Get Alert Configuration/,
  ...
  { id: 'notifications/add-notification-rule', group: 'Notifications', operation: 'Add Notification Rule', match: /^Add Notification Rule/,
  ...
  { id: 'notifications/get-alert-trigger-operators', group: 'Notifications', operation: 'Get Alert Trigger Operators', match: /^Get Alert Trigger Operators/,
  ...
  { id: 'notifications/get-alert-notification-old', group: 'Notifications', operation: 'Get Alert Notification (old)', match: /^Get Alert Notification/,
  ...
  // ── QA (10) ──────────────────────────────────────────────────────────
  { id: 'qa/get-available-qas', group: 'QA', operation: 'Get Available QAs', match: /^Get Available QAs/,
  ...
  { id: 'qa/get-qa', group: 'QA', operation: 'Get QA', match: /^Get QA/,
    cls: 'read', idSource: 'formId from Get Available QAs', reason: 'pointed probe', source: 'qa-api.spec.ts' },
  { id: 'qa/get-all-qas', group: 'QA', operation: 'Get All QAs', match: /^Get All QAs/,
  ...
  { id: 'qa/get-aqa-phrases', group: 'QA', operation: 'Get AQA Phrases', match: /^Get AQA Phrases/,
  ...
  { id: 'qa/generate-qa-pdf', group: 'QA', operation: 'Generate QA PDF', match: /^Generate QA PDF/,
    cls: 'blocked', reason: 'multipart/form-data body — the Try-it console only offers Raw/Binary', source: 'qa-api.spec.ts (skipped)' },
  { id: 'qa/generate-qa-excel', group: 'QA', operation: 'Generate QA Excel', match: /^Generate QA Excel/,
  ...
  { id: 'reports/list-report-templates', group: 'Reports', operation: 'List Report Templates', match: /^List Report Templates/,
    cls: 'read', reason: 'SUSPECTED SCOPING GAP — unchanged across switches; intent unclear. Triage.', source: 'SCOPING-suspected-gaps.md' },
  { id: 'reports/get-call-volume-statistics', group: 'Reports', operation: 'Get Call Volume Statistics', match: /^Get Call Volume Statistics/,
    cls: 'read', reason: 'confirmed site-scoped', source: 'reports-api.spec.ts; tenant-isolation-staging' },
  { id: 'reports/get-calls-counter', group: 'Reports', operation: 'Get Calls Counter', match: /^Get Calls Counter/,
    cls: 'read', reason: 'confirmed site-scoped', source: 'reports-api.spec.ts; tenant-isolation-staging' },
  { id: 'reports/get-site-usage-statistics', group: 'Reports', operation: 'Get Site Usage Statistics', match: /^Get Site Usage Statistics/,
  ...
  { id: 'reports/get-sites-storage-usage', group: 'Reports', operation: 'Get Sites Storage Usage', match: /^Get Sites Storage Usage/,
  ...
  { id: 'reports/get-six-month-call-volume', group: 'Reports', operation: 'Get Six Month Call Volume', match: /^Get Six Month Call Volume/,
    cls: 'read', reason: 'confirmed site-scoped', source: 'reports-api.spec.ts; tenant-isolation-staging' },
  { id: 'reports/get-storage-usage', group: 'Reports', operation: 'Get Storage Usage', match: /^Get Storage Usage/,
  ...
  { id: 'reports/get-user-activity-summary', group: 'Reports', operation: 'Get User Activity Summary', match: /^Get User Activity Summary/,
  ...
  { id: 'reports/get-report-by-template', group: 'Reports', operation: 'Get Report By Template', match: /^Get Report By Template/,
  ...
  { id: 'restricted-user/get-restricted-user', group: 'Restricted User Management', operation: 'Get Restricted User', match: /^Get Restricted User/,
  ...
  { id: 'role-mgmt/get-custom-role', group: 'Role Management', operation: 'Get Custom Role', match: /^Get Custom Role \(/,
  ...
  { id: 'site-mgmt/add-site', group: 'Site Management', operation: 'Add Site', match: /^Add Site/,
  ...
  { id: 'tag-mgmt/add-tag', group: 'Tag Management', operation: 'Add Tag', match: /^Add Tag/,
  ...
  { id: 'user-mgmt/get-user', group: 'User Management', operation: 'Get User', match: /^Get User/,
  ...
  { id: 'user-mgmt/add-user', group: 'User Management', operation: 'Add User', match: /^Add User/,
